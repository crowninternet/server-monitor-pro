...
# Uptime Monitor Pro - Proxmox 9 + Debian 13 Container Installer
# Version 1.2.0 - Optimized for LXC containers
...
print_header() {
    ...
    echo -e "${PURPLE}  Proxmox 9 + Debian 13 Edition${NC}"
    echo -e "${PURPLE}  Version 1.2.0 - Container Optimized${NC}"
    echo -e "${PURPLE}================================${NC}"
    echo ""
}
...
show_completion_message() {
    ...
    echo -e "   📁 ${BLUE}sudo $MANAGEMENT_SCRIPT info${NC}     - Show system info"
    echo -e "   📁 ${BLUE}sudo $MANAGEMENT_SCRIPT backup${NC}   - Create backup"
