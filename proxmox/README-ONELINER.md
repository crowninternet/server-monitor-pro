...
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/crowninternet/uptime-monitor/main/proxmox/uptime-monitor.sh)"
```
...
CTID=100 IP=192.168.1.100 GATEWAY=192.168.1.1 bash -c "$(curl -fsSL https://raw.githubusercontent.com/crowninternet/uptime-monitor/main/proxmox/uptime-monitor.sh)"
```
...
- **Uptime Monitor Pro:** `bash -c "$(curl -fsSL https://raw.githubusercontent.com/crowninternet/uptime-monitor/main/proxmox/uptime-monitor.sh)"`
